 ...
 */
@Entity
@Table(name="all_kiot_remotes")
@NamedQuery(name="AllKiotRemote.findAll", query="SELECT a FROM AllKiotRemote a")
public class AllKiotRemote implements Serializable {
