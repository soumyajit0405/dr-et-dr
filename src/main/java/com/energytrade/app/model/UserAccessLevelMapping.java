...
@NamedQuery(name="UserAccessLevelMapping.findAll", query="SELECT u FROM UserAccessLevelMapping u")
public class UserAccessLevelMapping implements Serializable {
